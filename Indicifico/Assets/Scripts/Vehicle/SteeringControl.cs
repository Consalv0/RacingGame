...
namespace RVP
{
    ...
    public class SteeringControl : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            {
                curSus.steerAngle = Mathf.Lerp(curSus.steerAngle, steerAmount * curSus.steerFactor * (curSus.steerEnabled ? 1 : 0) * (curSus.steerInverted ? -1 : 1), steerRate * Time.fixedDeltaTime);
            }
        }
